 ...
 * - Integration with CLOAKSCAN_DEBUG flag
 */
...
export class DebugLogger {
  ...
  constructor(component: string) {
    ...
    this.timers = new Map();
    this.metrics = [];
    this.enabled = process.env.CLOAKSCAN_DEBUG === 'true';
    this.jsonOutput = process.env.CLOAKSCAN_DEBUG_JSON === 'true';
  }
...
export function isProfilingEnabled(): boolean {
  return process.env.CLOAKSCAN_PROFILE === 'true';
}
