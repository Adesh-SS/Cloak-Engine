...
export class CloakScanError extends Error {
  constructor(
    message: string,
...
export function handleCommandError(
  ...
  if (error instanceof CloakScanError) {
    // Custom CloakScan errors
  ...
  if (details && process.env.CLOAKSCAN_DEBUG === 'true') {
