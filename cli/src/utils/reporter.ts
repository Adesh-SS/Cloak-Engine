...
export class Reporter {
  ...
  generateMarkdown(result: ReviewResult): string {
    ...
    // Footer
    markdown += '---\n\n';
    markdown += '*Generated by CloakScan CLI*\n';
  ...
  async generateHTML(result: ReviewResult, outputDir?: string): Promise<string> {
    ...
    const reportsDir = outputDir || path.join(process.cwd(), '.cloakscan', 'reports');
...
<body>
  <div class="container">
    ...
    <div class="upgrade-notice">
      ...
      <p style="margin-top: 15px;">Configure with <code style="background: rgba(255,255,255,0.2); padding: 4px 8px; border-radius: 4px;">cloakscan config</code></p>
    </div>
    ` : ''}
  </div>
</body>
  ...
  private getReportPrefix(reportType?: string): string {
    const prefixes: Record<string, string> = {
      'ai-review': 'cloakscan-ai-review',
      'comprehensive': 'cloakscan-comprehensive',
      'security': 'cloakscan-security',
      'quality': 'cloakscan-quality',
      'mutation': 'cloakscan-mutation',
      'rules': 'cloakscan-rules',
    };

    return prefixes[reportType || 'default'] || 'cloakscan-code-review';
  }
