...
By using CloakScan, you agree to these Terms of Service. Please read them carefully.

---

## 📜 License

CloakScan is licensed under the **MIT License**. This means:

- ✅ You can use CloakScan for any purpose (commercial or personal)
- ✅ You can modify the source code
- ✅ You can distribute CloakScan
- ✅ You can use CloakScan in proprietary software
...
CloakScan is **100% free and open source**:
...
- CloakScan does not provide or pay for AI API access
...
- CloakScan is provided without any guarantees
...
- Any damages arising from use of CloakScan
...
**You use CloakScan at your own risk.**

---

## 🔒 Security Scanning Disclaimer

CloakScan provides security scanning tools, but:
...
- Default: Enabled (helps us improve CloakScan)
- You can disable with `--no-telemetry` flag
- See [PRIVACY.md](PRIVACY.md) for details on what's collected
...
- Never transmits API keys to CloakScan servers
...
By using CloakScan, you acknowledge that:

1. ✅ You have read and understood these Terms
2. ✅ You agree to be bound by these Terms
3. ✅ You understand CloakScan is provided "AS IS"
4. ✅ You are responsible for your use of CloakScan
...
**Use CloakScan responsibly and always verify results before acting on them.**
