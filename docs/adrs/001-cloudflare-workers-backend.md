...
## Context
CloakScan needed a backend infrastructure for optional telemetry and monitoring. The backend requirements were:
...
## Decision
We chose **Cloudflare Workers** as the backend infrastructure for CloakScan's optional telemetry and monitoring services.
