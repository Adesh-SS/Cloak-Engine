...
This directory contains Architecture Decision Records for CloakScan - documentation of significant architectural and technical decisions made in the project.
