...
## Context
CloakScan's backend needs to store optional telemetry and monitoring data. The database requirements were:
...
## Decision
We chose **Supabase PostgreSQL** as the database for CloakScan's telemetry and monitoring backend.
