...
**CloakScan Multi-Language Parser API Reference**
...
CloakScan includes **8 language parsers** that extract code structure, functions, classes, and complexity metrics from source files. All parsers follow a consistent API pattern for ease of use.
